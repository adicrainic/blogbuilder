        ...
        <div class="container-fluid">
            ...
            <div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
                <p class="_title0">Permissions
                    <Select v-model="data.id" placeholder="Select Role" style="width: 300px" @on-change="changeRole">
...
export default {
    ...
    methods: {
        async assignRoles() {
            ...
            if(res.status === 200) {
                this.successMessage('Role has been assigned successfully')
        ...
        changeRole(){
            ...
            if(!permission) {
                this.resources = this.default_resources;
            }else{
